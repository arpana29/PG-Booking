...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb py-2">
            ...
            <li class="breadcrumb-item">
                <a href="property_list.php">Delhi</a>
            </li>
    ...
    <div id="property-images" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">                            
            <div class="carousel-item active">
                <img class="d-block w-100" src="img/properties\3\download.jpg" alt="slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img\properties\2\46ebbb537aa9fb0a.jpg" alt="slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/properties/2/45109c3e5c063d21.jpg" alt="slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/properties/2/6343da10f7206b0f.jpg" alt="slide">
            </div>
        </div>
    ...
    <div class="property-summary page-container">
        ...
        <div class="row no-gutters">
            ...
            <div class="button-container col-6">
                <a href="hotel.php" class="btn btn-primary">Book Now</a>
            </div>
        </div>
    </div>
    ...
    <div class="property-testimonials page-container">
        ...
        <div class="testimonial-block">
            <div class="testimonial-image-container">
                <img class="testimonial-img" src="img/appy.jpeg">
            </div>
            ...
            <div class="testimonial-name">- Arpana</div>
        </div>
        <div class="testimonial-block">
            <div class="testimonial-image-container">
                <img class="testimonial-img" src="img/anamika.jpeg">
            </div>
            <div class="testimonial-text">
                <i class="fa fa-quote-left" aria-hidden="true"></i>
                <p>You just have to arrive at the place, it's fully furnished and stocked with all basic amenities and services and even your friends are welcome.</p>
            </div>
            <div class="testimonial-name">- Anamika</div>
        </div>
    </div>
