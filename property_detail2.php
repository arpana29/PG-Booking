    ...
    <div id="property-images" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">                            
            <div class="carousel-item active">
                <img class="d-block w-100" src="img/properties/1/download.jpg" alt="slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/properties/1/image1.jpg" alt="slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/properties/1/image2.jpg" alt="slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/properties/1/bg2.png" alt="slide">
            </div>
        </div>
